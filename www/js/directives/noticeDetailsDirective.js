angular
    .module("starter")
    //获取已读通知
    .directive("readlistItem", function(
        $injector,
        DetailsNotice,
        SERVER,
        RootscopeApply
    ...
    //获取未读通知
    .directive("unreadlistItem", function(
        $injector,
        DetailsNotice,
        SERVER,
        RootscopeApply
    ...
    .directive("readWrap", function() {
        return {
            ...
            link: function postLink(scope, ele, attrs) {
                ...
                var widthLi =
                    $("#read-list li").width() +
                    parseInt($("#read-list li").css("marginLeft")) +
                    parseInt($("#read-list li").css("marginRight"));
                //计算在手机屏幕上可以容纳几个li
    ...
    .directive("notreadWrap", function() {
        return {
            ...
            link: function postLink(scope, ele, attrs) {
                var widthBox = ele[0].offsetWidth;
                var widthLi =
                    $("#notread-list li").width() +
                    parseInt($("#notread-list li").css("marginLeft")) +
                    parseInt($("#notread-list li").css("marginRight"));
